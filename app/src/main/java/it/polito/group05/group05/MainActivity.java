...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Query q = FirebaseDatabase.getInstance().getReference("groups").orderByChild("members").equalTo("-Kinzusz734fEaE7nYfe");
        FirebaseIndexRecyclerAdapter x = new FirebaseIndexRecyclerAdapter<GroupDatabase,GroupHolder>( GroupDatabase.class,
                                                            R.layout.group_item_sample,
                                                            GroupHolder.class,groupkey,ref){
