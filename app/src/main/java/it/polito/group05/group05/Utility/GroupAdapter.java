...
public class GroupAdapter extends ArrayAdapter<Group> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView groupProfile = (ImageView)convertView.findViewById(R.id.group_image);
        TextView name = (TextView)convertView.findViewById(R.id.tv_group_name);
        TextView balance = (TextView)convertView.findViewById(R.id.tv_group_balance);

        groupProfile = group.getGroupProfile();
        name.setText(group.getName());
        balance.setText(group.getBalance());
